...
export default function Dashboard({ user, profile: initialProfile }: DashboardProps) {
  ...
  const [activeView, setActiveView] = useState<'dashboard' | 'shop' | 'missions' | 'settings' | 'forum' | 'leaderboard' | 'privacy' | 'terms' | 'rules'>('dashboard');
  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      ...
      <main className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className={`mb-6 text-center transform transition-all duration-200 ease-out ${
        ...
        <div className={`mb-4 sm:mb-8 relative transform transition-all duration-500 ease-out ${
          showElements.banner 
            ? 'translate-y-0 opacity-100 scale-100' 
            : 'translate-y-16 opacity-0 scale-90'
        } ${showElements.bannerShake ? 'animate-bannerSlam' : ''}`}>
          <div className="flex justify-center max-w-7xl mx-auto">
            <img 
              src="/images/banner new logo.png" 
              alt="GameHub Banner" 
              className="w-full max-w-4xl mx-auto h-auto border border-orange-500/30 rounded-lg shadow-2xl"
            />
          </div>
        </div>
        ...
        {activeView === 'dashboard' ? (
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 sm:gap-8 min-h-screen">
            ...
            <div className={`lg:col-span-1 order-2 lg:order-1 space-y-6 transform transition-all duration-400 ease-out ${
                ...
                <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl border border-orange-500/20 rounded-2xl p-4 sm:p-6 space-y-4 shadow-xl shadow-orange-500/10">
                  ...
                  <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700/50 text-center">
                    <div className="flex items-center justify-center space-x-2 mb-1">
                      <span className="text-gray-400 text-sm">Current Bankroll</span>
                    </div>
                  ...
                  <div className="p-6">
                    <div className="text-center space-y-4">
                      <div className="bg-gray-800/50 rounded-lg p-4 border border-gray-700/50">
                        <h4 className="text-white font-semibold mb-2">Support & Inquiries</h4>
                        <a 
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        <div className="bg-gray-800/30 rounded-lg p-3 text-center">
                          ...
                          <p className="text-white text-sm">Game issues, bugs, account problems</p>
                        </div>
                        
                        <div className="bg-gray-800/30 rounded-lg p-3 text-center">
                          <p className="text-gray-400 text-sm mb-1">Business Inquiries</p>
                          <p className="text-white text-sm">Partnerships, licensing, media</p>
                        </div>
                        
                        <div className="bg-gray-800/30 rounded-lg p-3 text-center">
                          <p className="text-gray-400 text-sm mb-1">Feedback</p>
                          <p className="text-white text-sm">Suggestions, feature requests</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            {/* Animated Games Grid */}
            <div className={`lg:col-span-2 order-1 lg:order-2 transform transition-all duration-500 ease-out ${
            ...
            <div className={`lg:col-span-1 order-3 lg:order-3 space-y-6 transform transition-all duration-400 ease-out ${
...
function CollapsibleSection({ id, title, isCollapsed, onToggle, children }: CollapsibleSectionProps) {
  return (
