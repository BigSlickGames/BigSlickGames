  ...
  return (
    <header className="bg-gradient-to-r from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-b border-orange-500/20 shadow-lg shadow-orange-500/10 sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-14 sm:h-16 flex-wrap">
        ...
        <div className="absolute top-full left-0 right-0 bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-xl border-b border-orange-500/20 shadow-xl shadow-orange-500/10 z-50">
          <div className="container mx-auto px-4 py-4">
            <div className="space-y-2">
              {onMissionsClick && false && (
                <button
                  onClick={() => {
                    onMissionsClick();
                    setShowMobileMenu(false);
                  }}
                  className="w-full flex items-center space-x-3 px-4 py-3 text-gray-400 hover:text-purple-400 hover:bg-purple-500/20 rounded-lg transition-all touch-manipulation text-base"
                >
              ...
              {onLeaderboardClick && (
                <button
                  ...
                  className="w-full flex items-center space-x-3 px-4 py-3 text-gray-400 hover:text-yellow-400 hover:bg-yellow-500/20 rounded-lg transition-all touch-manipulation text-base"
                >
              ...
              {onForumClick && false && (
                <button
                  ...
                  className="w-full flex items-center space-x-3 px-4 py-3 text-gray-400 hover:text-blue-400 hover:bg-blue-500/20 rounded-lg transition-all touch-manipulation text-base"
                >
              ...
              <button
                ...
                className="w-full flex items-center space-x-3 px-4 py-3 text-gray-400 hover:text-red-400 hover:bg-red-500/20 rounded-lg transition-all touch-manipulation text-base"
              >
